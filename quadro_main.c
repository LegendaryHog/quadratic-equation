...
\detail Use in function "Unit_test ()"
*/
...
\return 1 - if user print "1" (agree to start solving)
0 - if user choose "0" (refused from solving)
*/
int Start_or_not (void);

/*!
Function that run function "Scan_one_coefficient" three times to read three coefficient.
...
/*!
Function that solve equation by "Solve_quadratic" and "Solve_linear" and determine roots and case of solution.
\param coef_a, coef_b, coef_c - values of coefficients
\param root_1, root_2 - addresses od roots
\param case_of_solution
*/
